...
namespace DACN.Services.NhanDienMau
{
    public class Mau5
    {
        public static bool Check(HtmlDocument doc)
        {
            ...
            if (nodeH1 == null)
                return false;
            var parentNodeH1 = nodeH1.ParentNode.ParentNode.ParentNode;
            var nodeText = doc.DocumentNode.SelectNodes(".//div/p");
            var checknote = nodeText.Where(p => p.ParentNode.ParentNode.ParentNode== parentNodeH1).ToList();
        ...
        public static NhanDienMauViewModel GetContent(HtmlDocument doc, string url)
        {
            ...
            var parentNodeH1 = nodeH1.ParentNode.ParentNode.ParentNode;
            var nodeText = doc.DocumentNode.SelectNodes(".//div/p");
            var checknote = nodeText.Where(t => t.ParentNode.ParentNode.ParentNode == parentNodeH1).ToList();
            int count = 0;
            ...
            return new NhanDienMauViewModel(url, H1, p, "Template 5");
        }
    }
}
